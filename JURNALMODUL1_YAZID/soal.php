...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    } elseif (ctype_digit($nama)) {
        $namaErr = "Nama harus berisi alphabet";
    }
    ...
    } elseif (ctype_digit($jurusan)) {
        $jurusanErr = "Jurusan harus berisi alphabet";
    }
    ...
    } elseif (ctype_digit($fakultas)) {
        $fakultasErr = "Fakultas harus berisi alphabet";
    }
