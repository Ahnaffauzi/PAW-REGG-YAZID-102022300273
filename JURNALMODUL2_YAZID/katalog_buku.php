...
$query = "SELECT * FROM db_buku WHERE judul LIKE '%$search%'";
...
<body>
    ...
    <div class="container mt-5">
        ...
        <form method="GET" action="katalog_buku.php" class="form-inline">
